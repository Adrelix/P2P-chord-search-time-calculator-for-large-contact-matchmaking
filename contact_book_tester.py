...
for premise in premises:
    database_size = premise.amount_of_users
    amount_of_packages = premise.optimal_package_distribution 

    for book_size in contact_book_sizes:
        latency_minimum = 1
        upload_speed_minimum = 0.1
        # Set Values
        ...
        book_dict[contact_book_size].append(average)        
...
plt.legend()
plt.show()
plt.savefig('contact_book_tester_plot.png')