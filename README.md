Calculates the estimated amount of time required to perform a large scale contact matchmaking over a distributed database using the chord search algorithm over a P2P network.
